...
readonly PROJECT_DIR="/www/wwwroot/GoAccess-管理"
...
-w /www/wwwroot/GoAccess-管理 -p rwxa -k goaccess_management

# 监控脚本执行
-w /www/wwwroot/GoAccess-管理/安装GoAccess.sh -p x -k goaccess_install
-w /www/wwwroot/GoAccess-管理/卸载GoAccess.sh -p x -k goaccess_uninstall
-w /www/wwwroot/GoAccess-管理/分析所有站点.sh -p x -k goaccess_analyze
-w /www/wwwroot/GoAccess-管理/GeoIP/更新GeoLite2.sh -p x -k goaccess_geoip

# 监控配置文件变更
-w /www/wwwroot/GoAccess-管理/站点配置 -p wa -k goaccess_config
-w /www/wwwroot/GoAccess-管理/配置模板.conf -p wa -k goaccess_config

# 监控日志文件访问
-w /www/wwwroot/GoAccess-管理/日志 -p wa -k goaccess_logs

# 监控 GeoIP 数据库变更
-w /www/wwwroot/GoAccess-管理/GeoIP -p wa -k goaccess_geoip_db
...
Cmnd_Alias GOACCESS_CMDS = /www/wwwroot/GoAccess-管理/*.sh
