...
项目提供了自动更新脚本 `脚本/更新GeoLite2.sh`，支持自动检测和更新数据库。
...
```bash
# 每天凌晨 3 点自动更新
0 3 * * * cd /home/www/GoAccess-Manage/脚本 && ./更新GeoLite2.sh >> /www/wwwlog/GoAccess-Manage/GeoIP更新日志.log 2>&1
```
...
# 添加定时任务（每天凌晨 3 点）
0 3 * * * cd /home/www/GoAccess-Manage/脚本 && ./更新GeoLite2.sh
```
